      ...
      <div className="body-width flex flex-wrap place-items-center mx-auto">
        <div className="intro flex flex-wrap place-items-center justify-around">
          <div className="w-11/12 sm:w-9/12">
            <h1 className="font-mono text-black font-bold text-3xl sm:text-4xl md:text-6xl mb-2 sm:mb-4 sm:leading-[3rem] md:leading-[4.25rem]">Better manage your day-to-day with Neuro-Aid.</h1>
