    ...
    <div className='flex basis-full bg-[#F2F2F2] w-screen'>
      <div className="body-width mx-auto">
        <div className="mt-8 mb-8 sm:mb-16">
          <h1 className="font-mono basis-full text-left text-black p-4 sm:mb-4 text-2xl sm:text-4xl font-bold" id="try-text">How did Neuro-Aid come to be?</h1>
          <div className="text-left leading-loose">
            <div>
              <div className="bg-white shadow-lg rounded-3xl px-4 py-4 sm:px-8 sm:py-6">
                <h2 className="text-base sm:text-lg font-semibold leading-loose mb-2">Our journey began with a deep-rooted passion to transform the lives of individuals managing ADHD.</h2>
            ...
            <div className="flex flex-wrap place-items-center">
              <div className="bg-white shadow-lg rounded-3xl px-4 py-4 sm:px-8 sm:py-6">
                <h2 className="text-base sm:text-lg font-semibold leading-loose mb-2">Driven by a genuine desire to make a positive impact, we embarked on a mission to create Neuro-Aid with meticulous attention to detail and a dedication to excellence.</h2>
                <p className="text-base sm:text-lg leading-loose">
              ...
              <div className="bg-white shadow-lg rounded-3xl px-4 py-4 sm:px-8 sm:py-6">
                <h2 className="text-base sm:text-lg font-semibold leading-loose mb-2">
