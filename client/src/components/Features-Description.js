function Features() {
  return (
    <div className="flex basis-full h-screen sm:h-[60vh] bg-blue" id='features-container'>
      <div className="m-auto body-width flex flex-wrap">
        <div className='flex flex-wrap basis-full'>
          <h1 className='font-mono basis-full text-black text-center sm:text-left font-bold mb-6 text-3xl md:text-4xl'>What Neuro-Aid provides for you</h1>
          <div className='bg-white shadow-lg rounded-3xl mb-8 px-4 py-4'>
            <div className='pb-2 flex place-items-center border-b-2 border-solid border-orange'>
            ...
            <div className='pb-2 mt-2 flex place-items-center border-b-2 border-solid border-orange'>
              <span className='basis-2/12 lg:basis-1/12'>
            ...
            <div className='basis-full flex place-items-center'>
          ...
          <div className='basis-full text-center sm:text-left'>
